...
"[project]/.next-internal/server/app/api/wishlist/grades/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/wishlist/grades/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (!ids) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        grades: []
    });
    const idList = ids.split(',').filter(Boolean).slice(0, 100);
    if (idList.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        grades: []
    });
    try {
        ...
        const { data, error } = await supabase.from('gundam_grades').select(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ef53e1ad._.js.map