...
const useAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        ...
        signOut: async ()=>{
            ...
            // (동적 import로 순환참조 방지)
            const { useWishlistStore } = await __turbopack_context__.r("[project]/src/store/wishlistStore.ts [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
            const { useProfileStore } = await __turbopack_context__.r("[project]/src/store/profileStore.ts [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
