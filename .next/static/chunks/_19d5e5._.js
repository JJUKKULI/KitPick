(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_19d5e5._.js", {
...
const useWishlistStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        items: [],
        toggle: (id)=>set({
                items: get().items.includes(id) ? get().items.filter((i)=>i !== id) : [
                    ...get().items,
                    id
                ]
            })
...
const mockProducts = [
    {
        id: 'p001',
        name: 'MG 프리덤 건담 Ver.2.0',
        series: '기동전사 건담 SEED',
        grade: 'MG 1/100',
        price: 44000,
        prevPrice: 50000,
        decision: 'buy',
        reasoning: '재판 주기 18개월 이상, 현재 최저가 갱신 중. 지금이 최적 매수 타이밍입니다.',
        popularity: 87,
        aiInsight: '커뮤니티 긍정 반응 82%, 가격 하락 추세 지속. Buy 신호 강함.',
    ...
    {
        id: 'p002',
        name: 'HGUC 하이누뉴 건담 버서스',
        series: '역습의 샤아',
        grade: 'HGUC 1/144',
        price: 38000,
        prevPrice: 31000,
        decision: 'wait',
        reasoning: 'Q2 재판 루머 확산 중. 재판 확정 시 정가 복귀 예상. 4~6주 대기 권장.',
        popularity: 91,
        aiInsight: '커뮤니티 재판 언급 +340%. 현재가는 프리미엄 구간.',
        ...
        communityComments: [
            {
                id: 'c4',
                userName: '역습팬',
                comment: '재판 소식 있음. 좀 더 기다리는 게 나을 듯',
                sentiment: 'neutral',
                source: 'dcinside'
            },
            {
    ...
    },
    {
        ...
        prevPrice: 55000,
        decision: 'watch',
        reasoning: '신극장판 재소비 흐름. 관심도 상승 중이나 가격 변동 없음.',
        popularity: 76,
        aiInsight: '관심도 상승세 지속 중. 가격 안정구간. 모니터링 권장.',
        ...
        communityComments: [
            {
                id: 'c6',
                userName: 'EVA팬',
                comment: '에바는 항상 옳다. 근데 가격이 너무 안 내려가네',
                sentiment: 'neutral',
                source: 'dcinside'
            }
        ]
    },
    {
        ...
        prevPrice: 195000,
        decision: 'trending',
        reasoning: 'UC 실사 드라마 공개 이후 커뮤니티 급상승. 관심도 +180%.',
        popularity: 95,
        aiInsight: '트렌딩 최고점. 관심도 급등 중. 가격 하락 후 매수 고려.',
    ...
    },
    {
        ...
        prevPrice: 68000,
        decision: 'buy',
        reasoning: '굿스마일 직영 재입고 확인. 현재 -9% 구간. 품절 후 프리미엄 전환 이력.',
        popularity: 82,
        aiInsight: '재입고 물량 소진 시 즉시 프리미엄 형성 예상. 지금이 타이밍.',
...
function DecisionBadge({ decision, size = 'sm' }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: `inline-flex items-center font-semibold rounded-full border ${cfg.color} ${cfg.bg} ${cfg.border} ${size === 'lg' ? 'text-sm px-4 py-1.5' : 'text-[11px] px-2.5 py-0.5'}`,
        children: cfg.label
    }, void 0, false, {
...
;
;
function DecisionCard({ product }) {
    _s();
    const { items: wishItems, toggle: toggleWish } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$wishlistStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWishlistStore"])();
    const { items: likeItems, toggle: toggleLike } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$likeStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLikeStore"])();
    const isWished = wishItems.includes(product.id);
    const isLiked = likeItems.includes(product.id);
    const priceDiff = product.price - product.prevPrice;
    const pctChange = Math.round(priceDiff / product.prevPrice * 100);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "bg-surface border border-surface-border rounded-xl overflow-hidden hover:border-surface-border-light transition-colors group",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: `h-1 ${product.decision === 'buy' ? 'bg-decision-buy' : product.decision === 'wait' ? 'bg-decision-wait' : product.decision === 'watch' ? 'bg-decision-watch' : 'bg-decision-trending'}`
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                            className: "text-sm font-semibold text-white leading-snug group-hover:text-brand-400 transition-colors line-clamp-2",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-xs text-zinc-500 leading-relaxed mb-4 line-clamp-2",
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: `flex items-center gap-0.5 text-[11px] font-medium ${priceDiff < 0 ? 'text-green-400' : priceDiff > 0 ? 'text-red-400' : 'text-zinc-500'}`,
                                        children: [
                                            priceDiff < 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$down$2d$right$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowDownRight$3e$__["ArrowDownRight"], {
                                                ...
                                                lineNumber: 36,
                                                columnNumber: 32
                                            }, this) : priceDiff > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$up$2d$right$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowUpRight$3e$__["ArrowUpRight"], {
                                                size: 12
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/product/DecisionCard.tsx",
                                                lineNumber: 36,
                                            ...
                                            priceDiff !== 0 ? `${Math.abs(pctChange)}%` : '변동없음'
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/product/DecisionCard.tsx",
                                        lineNumber: 35,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `p-1.5 rounded-lg transition-colors ${isLiked ? 'text-red-400 bg-red-500/10' : 'text-zinc-600 hover:text-zinc-400 hover:bg-surface-raised'}`,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `p-1.5 rounded-lg transition-colors ${isWished ? 'text-brand-500 bg-brand-500/10' : 'text-zinc-600 hover:text-zinc-400 hover:bg-surface-raised'}`,
...
_s(DecisionCard, "KVvubbS1cpDmzOYZKF1UD/ITFko=", false, function() {
    return [
...
function ProfilePage() {
    ...
    const { items } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$wishlistStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWishlistStore"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const [tab, setTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('wishlist');
    const wishProducts = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProducts"].filter((p)=>items.includes(p.id));
    const nickname = user?.user_metadata?.nickname ?? user?.email?.split('@')[0] ?? '게스트';
    async function handleSignOut() {
        await signOut();
        router.push('/');
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-4 sm:p-6 lg:p-10 max-w-3xl mx-auto",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-surface border border-surface-border rounded-xl p-6 mb-6",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex items-center gap-4",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "w-14 h-14 rounded-full bg-brand-500/20 border border-brand-500/30 flex items-center justify-center",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: "/settings",
                                    className: "p-2 rounded-lg text-zinc-500 hover:text-zinc-200 hover:bg-surface-raised transition-colors",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        onClick: ()=>setTab(t.id),
                        className: `flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${tab === t.id ? 'bg-brand-500/10 text-brand-500 border border-brand-500/30' : 'text-zinc-400 hover:text-zinc-200 border border-transparent'}`,
                        children: [
                            ...
                            t.label,
                            t.id === 'wishlist' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "text-xs ml-0.5 text-zinc-600",
                                children: [
                                    "(",
                                    wishProducts.length,
                                    ")"
            ...
            tab === 'wishlist' && (wishProducts.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4",
                children: wishProducts.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$product$2f$DecisionCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DecisionCard"], {
                        product: p
                    }, p.id, false, {
                        fileName: "[project]/src/app/(main)/profile/page.tsx",
                        lineNumber: 49,
...
_s(ProfilePage, "Y7EP/qa83dHCvU/Xqo5OtUmhQEA=", false, function() {
    return [
...
//# sourceMappingURL=_19d5e5._.js.map