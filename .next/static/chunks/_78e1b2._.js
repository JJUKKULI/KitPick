(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_78e1b2._.js", {

"[project]/src/store/settingsStore.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useSettingsStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        fetch: async (userId)=>{
            ...
            const { data, error } = await supabase.from('user_settings').select('price_drop_alert, reprint_alert, trending_alert, popularity_alert').eq('user_id', userId).single();
            if (!error && data) {
                set({
                    settings: {
                        ...data
                ...
                // row 없음 → upsert 기본값
                const { error: insertErr } = await supabase.from('user_settings').upsert({
                    user_id: userId,
                    ...defaults
                });
                ...
                set({
                    loading: false,
                    lastError: error?.message ?? '불러오기 실패'
                });
            }
        },
        update: (key, value)=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$themeStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/store/themeStore.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$settingsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/store/settingsStore.ts [app-client] (ecmascript)");
...
function Toggle({ enabled, onChange, disabled }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        disabled: disabled,
        className: `relative w-11 h-6 rounded-full transition-colors duration-200 disabled:opacity-40 cursor-pointer ${enabled ? 'bg-brand-500' : 'bg-surface-raised border border-surface-border'}`,
...
const notifItems = [
    ...
    },
    {
        key: 'trending_alert',
        label: '트렌딩 알림',
        desc: '관심 시리즈 트렌딩 진입 시'
    },
    {
        key: 'popularity_alert',
        label: '인기도 변동 알림',
        desc: '찜한 키트 인기도 급변 시'
    }
];
...
function SettingsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            if (lastError) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('error', '설정 저장 실패', lastError);
        }
    }["SettingsPage.useEffect"], [
        lastError
    ]);
    ...
    async function handleSave() {
        ...
        if (ok) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('success', '설정 저장 완료', '알림 설정이 저장됐어요.');
            // 브라우저 알림 권한 요청
            if ("object" !== 'undefined' && 'Notification' in window && Notification.permission === 'default') {
                const perm = await Notification.requestPermission();
                if (perm === 'granted') (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('info', '브라우저 알림 허용됨', '알림을 받을 수 있어요.');
            }
        }
    }
    // ── 브라우저 알림 테스트 ──────────────────────────────────────────────────
    function sendBrowserNotification(label) {
        if ("object" === 'undefined' || !('Notification' in window)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('error', '브라우저가 알림을 지원하지 않아요');
            return;
        }
        if (Notification.permission === 'granted') {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('success', '브라우저 알림 발송됨');
        } else if (Notification.permission === 'default') {
            Notification.requestPermission().then((p)=>{
                if (p === 'granted') sendBrowserNotification(label);
                else (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('info', '알림 권한이 필요해요', '브라우저 설정에서 허용해주세요.');
            });
        } else {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('error', '브라우저 알림이 차단됐어요', '브라우저 설정에서 권한을 허용해주세요.');
        }
    }
    // ── 이메일 알림 테스트 ────────────────────────────────────────────────────
    async function sendEmailNotification(key, label) {
        if (!user?.email) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('error', '이메일 정보가 없어요');
            return;
        }
        setTestingKey(key);
        try {
            const res = await fetch(`/api/notify`, {
                ...
                body: JSON.stringify({
                    type: 'email',
                    alertType: alertTypeMap[key]
                })
            });
            const data = await res.json();
            if (res.ok) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('success', '이메일 발송됨', `${user.email}으로 전송했어요.`);
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('error', '이메일 발송 실패', data.error ?? '잠시 후 다시 시도해주세요.');
            }
        } catch  {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('error', '네트워크 오류');
        } finally{
            setTestingKey(null);
        }
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-4 sm:p-6 lg:p-10 max-w-2xl mx-auto w-full pb-24 md:pb-10",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    dirty && user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: handleSave,
                        disabled: saving,
                    ...
                    !dirty && !loading && user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: notifItems.map((item)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Toggle, {
                                                        ...
                                                        onChange: (v)=>{
                                                            if (!user) {
                                                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('info', '로그인이 필요합니다');
                                                                return;
                                                            }
                                                            update(item.key, v);
                                                        },
                                            ...
                                            isOn && !dirty && user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center gap-2 mt-3 pt-3 border-t border-surface-border/60",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-xs text-zinc-600 mr-1",
                                                        children: "테스트 발송:"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(main)/settings/page.tsx",
                                                        lineNumber: 189,
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-xs text-zinc-500 mt-0.5",
                                                children: isDark ? '현재: 다크 테마' : '현재: 라이트 테마'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(main)/settings/page.tsx",
                                                lineNumber: 225,
                                                columnNumber: 15
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                className: "text-xs text-zinc-500 mt-0.5",
                                                children: "내 찜·검색 데이터를 AI 개선에 활용 (익명 처리)"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/(main)/settings/page.tsx",
                                                lineNumber: 240,
                                                columnNumber: 15
...
_s(SettingsPage, "OfWE3Bz5JLchgx1bzJbFoIfyaEo=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$settingsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSettingsStore"]
    ];
});
_c1 = SettingsPage;
var _c, _c1;
...
//# sourceMappingURL=_78e1b2._.js.map