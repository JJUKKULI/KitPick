(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_ee99b2._.js", {
...
const useSettingsStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        fetch: async (userId)=>{
            ...
            if (!error && data) {
                set({
                    settings: {
                        price_drop_alert: data.price_drop_alert,
                        reprint_alert: data.reprint_alert,
                        trending_alert: data.trending_alert,
                        popularity_alert: data.popularity_alert
                    },
                    loading: false,
                    dirty: false
                });
...
function Toggle({ enabled, onChange, disabled }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        disabled: disabled,
        className: `relative w-11 h-6 rounded-full transition-colors duration-200 disabled:opacity-40 ${enabled ? 'bg-brand-500' : 'bg-surface-raised border border-surface-border'}`,
...
function SettingsPage() {
    ...
    const { settings, loading, dirty, fetch, update, save } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$settingsStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSettingsStore"])();
    // 유저 있으면 설정 로드
    ...
    async function handleSave() {
        ...
        try {
            ...
            // 브라우저 알림 권한 요청 (ON으로 바꾼 항목이 있는 경우)
            const anyOn = Object.values(settings).some(Boolean);
            if (anyOn && "object" !== 'undefined' && 'Notification' in window) {
                if (Notification.permission === 'default') {
                    const perm = await Notification.requestPermission();
                    if (perm === 'granted') {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('info', '알림 권한 허용됨', 'KitPick 알림을 받을 수 있어요.');
                    }
                }
            }
        } catch  {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('error', '저장 실패', '잠시 후 다시 시도해주세요.');
        }
    }
    // 브라우저 푸시 알림 테스트 함수
    function sendTestNotification(label) {
        if ("object" === 'undefined' || !('Notification' in window)) return;
        if (Notification.permission === 'granted') {
            new Notification('KitPick 알림 테스트', {
                body: `${label} 알림이 활성화됐습니다.`,
                icon: '/favicon.ico'
            });
        } else {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('info', '브라우저 알림 권한이 필요해요', '설정 저장 시 권한을 요청합니다.');
        }
    }
    const notifItems = [
        {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-4 sm:p-6 lg:p-10 max-w-2xl mx-auto w-full",
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: notifItems.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center gap-3",
                                                children: [
                                                    settings[item.key] && !dirty && user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        onClick: ()=>sendTestNotification(item.label),
                                                        className: "text-[11px] text-zinc-600 hover:text-brand-400 transition-colors",
                                                        children: "테스트"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(main)/settings/page.tsx",
                                                        lineNumber: 118,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Toggle, {
                                                        ...
                                                        onChange: (v)=>{
                                                            if (!user) {
                                                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('info', '로그인이 필요합니다', '알림 설정은 로그인 후 가능해요.');
                                                                return;
                                                            }
                                                            update(item.key, v);
                                                            if (v) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$Toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('info', `${item.label} 켜짐`, '저장 버튼을 눌러 적용하세요.');
                                                        },
                                                        disabled: loading
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/(main)/settings/page.tsx",
...
_s(SettingsPage, "GrfrlKdwADIL+KY09cUf6Qy66kE=", false, function() {
    return [
...
//# sourceMappingURL=_ee99b2._.js.map