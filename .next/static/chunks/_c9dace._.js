(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_c9dace._.js", {
...
const ALL_GRADES = [
    ...
    },
    {
        ...
        label: 'PG',
        scale: '1/60',
        badge: 'bg-decision-buy/20 text-decision-buy border-decision-buy/30',
        keywords: [
            'PG ',
            '1/60'
        ]
    },
    {
        ...
        label: '무등급 (NG)',
        scale: '다양',
        badge: 'bg-zinc-600/40 text-zinc-400 border-zinc-500/30',
        keywords: [
            '무등급',
            '1/100 NG'
        ]
...
function matchGradeSlot(dbGrade) {
    ...
    if ([
        'mg',
        'mg '
    ].some((k)=>g.startsWith(k)) && !g.includes('ver.ka')) return 'mg';
    if ([
        'hg',
        'hguc',
        'hgce',
        'hgibo'
    ].some((k)=>g.startsWith(k))) return 'hg';
...
function GundamDetailPage() {
    ...
    const [dbGrades, setDbGrades] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // 등급 슬롯별 네이버 결과 map: gradeId → NaverResult
    const [naverMap, setNaverMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GundamDetailPage.useEffect": ()=>{
            if (!gundam) return;
            const gundamName = gundam.name.replace(/^(SD|HG|RG|MG|PG|HGUC|HGCE|EG)\s+/i, '').trim();
            // 초기 loading 상태
            const init = {};
            ALL_GRADES.forEach({
            ...
            ALL_GRADES.forEach({
                "GundamDetailPage.useEffect": (slot, i)=>{
                    // DB에 해당 슬롯 일치 등급이 있으면 그 naver_query 우선 사용
                    const matched = dbGrades.find({
                        "GundamDetailPage.useEffect.matched": (d)=>matchGradeSlot(d.grade) === slot.id
                    }["GundamDetailPage.useEffect.matched"]);
                    const query = matched?.naver_query ?? buildQuery(slot.id, gundamName);
                    setTimeout({
                    ...
                    }["GundamDetailPage.useEffect"], i * 250);
                }
            }["GundamDetailPage.useEffect"]);
        }
    }["GundamDetailPage.useEffect"], [
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: `inline-block text-xs font-bold px-3 py-1.5 rounded-full border ${slot.badge}`,
                                                    children: slot.label
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(main)/gundam/[gundamId]/page.tsx",
                                                    lineNumber: 193,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    officialPrice && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            !naver || naver.status === 'loading' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                lineNumber: 217,
                                                                columnNumber: 27
                                                            }, this) : naver.status === 'found' && naver.price ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                                href: naver.link,
                                                                target: "_blank",
                                        ...
                                        dbGrade?.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            href: `/gundam/${gundamId}/${dbGrade.id}`,
...
_s(GundamDetailPage, "vHezmv1NTYBC+o+Z0uP8IdI4jac=", false, function() {
    return [
...
_c = GundamDetailPage;
// 슬롯별 네이버 검색 쿼리 자동 생성
function buildQuery(slotId, gundamName) {
    const queries = {
...
//# sourceMappingURL=_c9dace._.js.map